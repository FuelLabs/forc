...
async fn assert_big_contract_calls(wallet: Wallet, contract_id: ContractId) {
    abigen!(Contract(
        name = "BigContract",
        abi = "forc-client/test/data/big_contract/big_contract-abi.json"
    ));
...
async fn test_proxy_contract_re_routes_call() {
    ...
    abigen!(Contract(
        ...
        abi = "forc-client/test/data/standalone_contract/standalone_contract-abi.json"
    ));
...
async fn deploy_script_calls() {
    ...
    abigen!(Script(
        name = "MyScript",
        abi = "forc-client/test/data/deployed_script/deployed_script-abi.json"
    ));
...
async fn deployed_predicate_call() {
    ...
    abigen!(Predicate(
        name = "MyPredicate",
        abi = "forc-client/test/data/deployed_predicate/deployed_predicate-abi.json"
    ));
...
async fn call_with_forc_generated_overrides(node_url: &str, contract_id: ContractId) -> String {
    ...
    // this path is basically, `forc-client/test/data/deployed_script/deployed_script-loader-abi.json`.
    ...
    abigen!(Script(
        name = "MyScript",
        abi = "forc-client/test/data/deployed_script/deployed_script-loader-abi.json"
    ));
